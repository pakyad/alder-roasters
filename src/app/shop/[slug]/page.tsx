    ...
    <PageTransition>
      ...
      <Container>
        ...
        <section className={styles.hero}>
          ...
          <div className={`${styles.summary} entrance`} style={{ "--entrance-delay": "140ms" } as React.CSSProperties}>
        ...
        <section className={styles.storyRail} aria-label={`The story of ${coffee.name}`} {...reveal(0)}>
